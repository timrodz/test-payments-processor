...
describe("SuperuserHomeFeature", () => {
  ...
  it("renders the admin dashboard with management cards", () => {
    ...
    expect(screen.getByText("Manage Trips", { selector: '[data-slot="card-title"]' })).toBeDefined();
    expect(screen.getByText("Manage Schools", { selector: '[data-slot="card-title"]' })).toBeDefined();
